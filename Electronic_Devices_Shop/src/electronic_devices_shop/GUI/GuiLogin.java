        ...
        panelLogin = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                if (g instanceof Graphics2D graphics2D) {
                    Paint p
                            = new GradientPaint(0.0f, 0.0f, new Color(0,0,0, 250),//0, 77, 64, 250
                            getWidth(), getHeight(), new Color(0,0,0, 180), true);//0, 105, 92, 180
...
//        }
        ...
        txtUsername.setBackground(new Color(48, 48, 48));
        ...
        txtPassword.setBackground(new Color(49, 49, 49));
